...
function sendNotification(count) {
  ...
  var message = 'The 311 script completed and wrote ' + count + ' rows into table ' + tableName + '.  I just thought you might want to know...';
